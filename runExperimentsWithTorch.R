...
metapath <- "~/Work/bhk/data/l1k/2020/"
datapath <- "~/Work/bhk/data/l1k/2020/"

hepg2_train <- l1k_dataset(metapath=metapath, datapath=datapath, cell_id="HEPG2")
a375_test <- l1k_dataset(metapath=metapath, datapath=datapath, cell_id="A375")

train_dl <- dataloader(hepg2_train, batch_size = 1, shuffle = TRUE)
test_dl <- dataloader(a375_test, batch_size = 1, shuffle = TRUE)
